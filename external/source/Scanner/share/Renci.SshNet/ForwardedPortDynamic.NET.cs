...
namespace Renci.SshNet
{
    public partial class ForwardedPortDynamic
    {
        ...
        private Renci.SshNet.Common.CountdownEvent _pendingChannelCountdown;
        ...
        {
            var original = Interlocked.Exchange(ref _pendingChannelCountdown, new Renci.SshNet.Common.CountdownEvent(1));
            if (original != null)
            {
                original.Dispose();
            }
